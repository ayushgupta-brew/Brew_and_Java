...
public class PostOrderTraversal {
    ...
    root.right.right.left =new

    TreeNode(9);

    // Perform postorder traversal using DFS
    List<Integer> answer = postorderTraversalDFS(root);
    ...
    public static List<Integer> postorderTraversalDFS(TreeNode root){
        ...
        // Stores the final postorder result
